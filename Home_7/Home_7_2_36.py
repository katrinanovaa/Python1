...
# строки и столбца, т.е. функцию двух аргументов. Аргументы ```num_rows``` и 
# ```num_columns``` указывают число строк и столбцов таблицы, которые должны 
# быть распечатаны. Нумерация строк и столбцов идет с единицы.
...
def print_operation_table(operation, num_rows=6, num_columns=6):
    for x in range(num_columns): 
        ...
        for y in range(num_rows):
            array_input.append(operation(x+1, y+1)) 
        print(array_input)
